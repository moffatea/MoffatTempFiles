...
conf['ffhadron parametrization']='0h'

conf['params']['ffhadron']['g1 N']  ={'value':    2.23793e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffhadron']['g1 a']  ={'value':    2.00000e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffhadron']['g1 b']  ={'value':    2.33359e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffhadron']['g1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffhadron']['g1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffhadron']['u1 N']  ={'value':    1.00000e+00, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffhadron']['u1 a']  ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffhadron']['u1 b']  ={'value':    8.53586e-01, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffhadron']['u1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffhadron']['u1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffhadron']['d1 N']  ={'value':    1.00000e+00, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['d1 a']  ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['d1 b']  ={'value':    8.53586e-01, 'min':  0   , 'max':    10,'fixed':'u1 b'}
#conf['params']['ffhadron']['d1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['d1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffhadron']['s1 N']  ={'value':    1.00000e+00, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['s1 a']  ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['s1 b']  ={'value':    8.53586e-01, 'min':  0   , 'max':    10,'fixed':'u1 b'}
#conf['params']['ffhadron']['s1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['s1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffhadron']['c1 N']  ={'value':    3.76616e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffhadron']['c1 a']  ={'value':   -6.83675e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffhadron']['c1 b']  ={'value':    4.96375e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffhadron']['c1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffhadron']['c1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffhadron']['b1 N']  ={'value':    4.20773e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffhadron']['b1 a']  ={'value':   -1.40044e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffhadron']['b1 b']  ={'value':    3.91280e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffhadron']['b1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffhadron']['b1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffhadron']['ub1 N'] ={'value':    1.00000e+00, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['ub1 a'] ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['ub1 b'] ={'value':    8.53586e-01, 'min':  0   , 'max':    10,'fixed':'u1 b'}
#conf['params']['ffhadron']['ub1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['ub1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffhadron']['db1 N'] ={'value':    1.00000e+00, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['db1 a'] ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['db1 b'] ={'value':    8.53586e-01, 'min':  0   , 'max':    20,'fixed':'u1 b'}
#conf['params']['ffhadron']['db1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['db1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffhadron']['sb1 N'] ={'value':    1.00000e+00, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['sb1 a'] ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['sb1 b'] ={'value':    8.53586e-01, 'min':  0   , 'max':    10,'fixed':'u1 b'}
#conf['params']['ffhadron']['sb1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['sb1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffhadron']['cb1 N'] ={'value':    3.76616e-01, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
conf['params']['ffhadron']['cb1 a'] ={'value':   -6.83675e-01, 'min': -1.8 , 'max':     2,'fixed':'c1 a'}
conf['params']['ffhadron']['cb1 b'] ={'value':    4.96375e+00, 'min':  0   , 'max':    10,'fixed':'c1 b'}
#conf['params']['ffhadron']['cb1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'c1 c'}
#conf['params']['ffhadron']['cb1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'c1 d'}

conf['params']['ffhadron']['bb1 N'] ={'value':    4.20773e-01, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
conf['params']['ffhadron']['bb1 a'] ={'value':   -1.40044e+00, 'min': -1.8 , 'max':     2,'fixed':'b1 a'}
conf['params']['ffhadron']['bb1 b'] ={'value':    3.91280e+00, 'min':  0   , 'max':    10,'fixed':'b1 b'}
...
conf['steps'][1]={}
conf['steps'][1]['dep']=[]
conf['steps'][1]['active distributions']=['ffhadron']
conf['steps'][1]['datasets']={}
conf['steps'][1]['datasets']['sia']=[]
conf['steps'][1]['datasets']['sia'].append(4000)
conf['steps'][1]['datasets']['sia'].append(4001)
conf['steps'][1]['datasets']['sia'].append(4002)
conf['steps'][1]['datasets']['sia'].append(4003)
conf['steps'][1]['datasets']['sia'].append(4004)
conf['steps'][1]['datasets']['sia'].append(4005)
conf['steps'][1]['datasets']['sia'].append(4006)
conf['steps'][1]['datasets']['sia'].append(4007)
#conf['steps'][1]['datasets']['sia'].append(4009)
#conf['steps'][1]['datasets']['sia'].append(4010)
#conf['steps'][1]['datasets']['sia'].append(4012)

#--pdf idis and no hera
#conf['steps'][2]={}
#conf['steps'][2]['dep']=[1]
#conf['steps'][2]['active distributions']=['pdf','ffhadron']
#conf['steps'][2]['passive distributions']=['ffhadron']
...
#conf['steps'][3]['active distributions']=['pdf','ffhadron']
#conf['steps'][3]['passive distributions']=['pdf']
#conf['steps'][3]['datasets']={}
#conf['steps'][3]['datasets']['sidis']=[]
#conf['steps'][3]['datasets']['sidis'].append(3000) # deuteron , mult , h+  , COMPASS
#conf['steps'][3]['datasets']['sidis'].append(3001) # deuteron , mult , h-  , COMPASS
