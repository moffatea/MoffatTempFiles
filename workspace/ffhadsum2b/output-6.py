...
conf['datasets']['sidis']['norm'][1005]={'value':    1.00003e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][1006]={'value':    1.00019e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][1007]={'value':    9.97300e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][1008]={'value':    1.00084e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][1009]={'value':    1.00003e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][1010]={'value':    1.00006e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][2005]={'value':    9.99974e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][2006]={'value':    9.99988e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][2007]={'value':    1.50000e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][2008]={'value':    1.50000e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][2009]={'value':    1.00000e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sidis']['norm'][2010]={'value':    1.00001e+00,'fixed':False,'min':0.5,'max':1.5}
...
conf['params']['ffpion']['g1 N']  ={'value':    3.17212e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['g1 a']  ={'value':    2.00000e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['g1 b']  ={'value':    7.30215e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['g1 c']  ={'value':    4.32181e+00, 'min':  0   , 'max':    20,'fixed':False}
conf['params']['ffpion']['g1 d']  ={'value':    1.54590e+01, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['u1 N']  ={'value':    2.88217e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['u1 a']  ={'value':   -1.43874e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['u1 b']  ={'value':    1.09868e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['u1 c']  ={'value':    6.23549e-04, 'min':  0   , 'max':    20,'fixed':False}
conf['params']['ffpion']['u1 d']  ={'value':    1.46267e+00, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['d1 N']  ={'value':    1.77873e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['d1 a']  ={'value':   -1.57499e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['d1 b']  ={'value':    1.73042e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['d1 c']  ={'value':    5.48084e-03, 'min':  0   , 'max':    20,'fixed':False}
conf['params']['ffpion']['d1 d']  ={'value':    2.27345e+00, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['s1 N']  ={'value':    1.77873e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['s1 a']  ={'value':   -1.57499e+00, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['s1 b']  ={'value':    1.73042e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffpion']['s1 c']  ={'value':    5.48084e-03, 'min':  0   , 'max':    20,'fixed':'d1 c'}
conf['params']['ffpion']['s1 d']  ={'value':    2.27345e+00, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffpion']['c1 N']  ={'value':    1.00000e+00, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['c1 a']  ={'value':   -1.10195e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['c1 b']  ={'value':    1.12151e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffpion']['c1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffpion']['c1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['b1 N']  ={'value':    1.18981e-12, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['b1 a']  ={'value':    1.98100e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['b1 b']  ={'value':    3.95861e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffpion']['b1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffpion']['b1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['ub1 N'] ={'value':    1.77873e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['ub1 a'] ={'value':   -1.57499e+00, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['ub1 b'] ={'value':    1.73042e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffpion']['ub1 c']  ={'value':    5.48084e-03, 'min':  0   , 'max':    20,'fixed':'d1 c'}
conf['params']['ffpion']['ub1 d']  ={'value':    2.27345e+00, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffpion']['db1 N'] ={'value':    2.88217e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffpion']['db1 a'] ={'value':   -1.43874e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffpion']['db1 b'] ={'value':    1.09868e+00, 'min':  0   , 'max':    10,'fixed':'u1 b'}
conf['params']['ffpion']['db1 c']  ={'value':    6.23549e-04, 'min':  0   , 'max':    20,'fixed':'u1 c'}
conf['params']['ffpion']['db1 d']  ={'value':    1.46267e+00, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffpion']['sb1 N'] ={'value':    1.77873e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['sb1 a'] ={'value':   -1.57499e+00, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['sb1 b'] ={'value':    1.73042e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffpion']['sb1 c']  ={'value':    5.48084e-03, 'min':  0   , 'max':    20,'fixed':'d1 c'}
conf['params']['ffpion']['sb1 d']  ={'value':    2.27345e+00, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffpion']['cb1 N'] ={'value':    1.00000e+00, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
conf['params']['ffpion']['cb1 a'] ={'value':   -1.10195e+00, 'min': -1.8 , 'max':     2,'fixed':'c1 a'}
conf['params']['ffpion']['cb1 b'] ={'value':    1.12151e+00, 'min':  0   , 'max':    10,'fixed':'c1 b'}
#conf['params']['ffpion']['cb1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'c1 c'}
#conf['params']['ffpion']['cb1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'c1 d'}

conf['params']['ffpion']['bb1 N'] ={'value':    1.18981e-12, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
conf['params']['ffpion']['bb1 a'] ={'value':    1.98100e+00, 'min': -1.8 , 'max':     2,'fixed':'b1 a'}
conf['params']['ffpion']['bb1 b'] ={'value':    3.95861e+00, 'min':  0   , 'max':    10,'fixed':'b1 b'}
...
conf['params']['ffhadron']['g1 N']  ={'value':    6.27685e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['u1 N']  ={'value':    5.65740e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['d1 N']  ={'value':    5.65740e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
...
conf['params']['ffhadron']['s1 N']  ={'value':    7.62986e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
...
conf['params']['ffhadron']['c1 N']  ={'value':   -1.11381e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['b1 N']  ={'value':    6.05260e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['ub1 N'] ={'value':    7.62986e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
...
conf['params']['ffhadron']['db1 N'] ={'value':    6.52642e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
...
conf['params']['ffhadron']['sb1 N'] ={'value':    5.65740e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
...
conf['params']['ffhadron']['cb1 N'] ={'value':   -1.11381e-01, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
...
conf['params']['ffhadron']['bb1 N'] ={'value':    6.05260e-01, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
...
conf['params']['pdf']['g1 N']    ={'value':    3.29040e-01, 'min':  None, 'max':  None, 'fixed': True }
conf['params']['pdf']['g1 a']    ={'value':    8.50832e-01, 'min':  -1.9, 'max':     1, 'fixed': False}
conf['params']['pdf']['g1 b']    ={'value':    4.68054e+00, 'min':     0, 'max':    10, 'fixed': False}

conf['params']['pdf']['uv1 N']   ={'value':    3.60321e-01, 'min':  None, 'max':  None, 'fixed': True }
conf['params']['pdf']['uv1 a']   ={'value':   -1.69812e-01, 'min':  -0.5, 'max':     1, 'fixed': False}
conf['params']['pdf']['uv1 b']   ={'value':    2.77786e+00, 'min':     0, 'max':    10, 'fixed': False}

conf['params']['pdf']['dv1 N']   ={'value':    1.13400e-01, 'min':  None, 'max':  None, 'fixed': True }
conf['params']['pdf']['dv1 a']   ={'value':   -5.00000e-01, 'min':  -0.5, 'max':     1, 'fixed': False}
conf['params']['pdf']['dv1 b']   ={'value':    2.90917e+00, 'min':     0, 'max':    10, 'fixed': False}

conf['params']['pdf']['db1 N']   ={'value':    3.09378e-02, 'min':     0, 'max':     1, 'fixed': False}
conf['params']['pdf']['db1 a']   ={'value':   -6.95991e-02, 'min':    -1, 'max':     1, 'fixed': False}
conf['params']['pdf']['db1 b']   ={'value':    6.30985e+00, 'min':     0, 'max':    10, 'fixed': False}

conf['params']['pdf']['ub1 N']   ={'value':    3.44702e-03, 'min':     0, 'max':     1, 'fixed': False}
conf['params']['pdf']['ub1 a']   ={'value':   -1.00000e+00, 'min':    -1, 'max':     1, 'fixed': False}
conf['params']['pdf']['ub1 b']   ={'value':    9.99999e+00, 'min':     0, 'max':    10, 'fixed': False}

conf['params']['pdf']['s1 N']    ={'value':    3.01155e-02, 'min':     0, 'max':     1, 'fixed': True }
conf['params']['pdf']['s1 a']    ={'value':    1.00000e+00, 'min':  -0.5, 'max':     1, 'fixed': False}
conf['params']['pdf']['s1 b']    ={'value':    5.45957e+00, 'min':     0, 'max':    10, 'fixed': False}

conf['params']['pdf']['sb1 N']   ={'value':    3.01086e-02, 'min':     0, 'max':     1, 'fixed': False}
conf['params']['pdf']['sb1 a']   ={'value':    1.00000e+00, 'min':  -0.5, 'max':     1, 'fixed': False}
conf['params']['pdf']['sb1 b']   ={'value':    5.46150e+00, 'min':     0, 'max':    10, 'fixed': False}

conf['params']['pdf']['sea1 N']  ={'value':    1.13743e-02, 'min':     0, 'max':     1, 'fixed': False}
conf['params']['pdf']['sea1 a']  ={'value':   -1.13664e+00, 'min':  -1.9, 'max':    -1, 'fixed': False}
conf['params']['pdf']['sea1 b']  ={'value':    1.00000e+01, 'min':     0, 'max':    10, 'fixed': False}

conf['params']['pdf']['sea2 N']  ={'value':    1.13743e-02, 'min':     0, 'max':     1, 'fixed': 'sea1 N'}
conf['params']['pdf']['sea2 a']  ={'value':   -1.13664e+00, 'min':  -1.9, 'max':    -1, 'fixed': 'sea1 a'}
