...
conf['datasets']['idis']['xlsx'][10020]='idis/expdata/10030.xlsx'
...
conf['datasets']['idis']['norm'][10026]={'value':   1, 'min': 8.00000e-01, 'max': 1.20000e+00, 'fixed': False}
conf['datasets']['idis']['norm'][10027]={'value':   1, 'min': 8.00000e-01, 'max': 1.20000e+00, 'fixed': False}
conf['datasets']['idis']['norm'][10028]={'value':   1, 'min': 8.00000e-01, 'max': 1.20000e+00, 'fixed': False}
conf['datasets']['idis']['norm'][10029]={'value':   1, 'min': 8.00000e-01, 'max': 1.20000e+00, 'fixed': False}
conf['datasets']['idis']['norm'][10030]={'value':   1, 'min': 8.00000e-01, 'max': 1.20000e+00, 'fixed': False}
conf['datasets']['idis']['norm'][10031]={'value':   1, 'min': 8.00000e-01, 'max': 1.20000e+00, 'fixed': False}
conf['datasets']['idis']['norm'][10032]={'value':   1, 'min': 8.00000e-01, 'max': 1.20000e+00, 'fixed': False}
...
conf['steps'][1]['datasets']['idis'].append(10026)
conf['steps'][1]['datasets']['idis'].append(10027) 
conf['steps'][1]['datasets']['idis'].append(10028) 
conf['steps'][1]['datasets']['idis'].append(10029) 
conf['steps'][1]['datasets']['idis'].append(10030) 
conf['steps'][1]['datasets']['idis'].append(10031) 
conf['steps'][1]['datasets']['idis'].append(10032) 
