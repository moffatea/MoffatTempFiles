...
conf['datasets']['sia']['norm'][4000]={'value':    1.06886e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][4002]={'value':    1.06240e+00,'fixed':False,'min':0.5,'max':1.5}
...
conf['datasets']['sia']['norm'][4009]={'value':    6.51005e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][4010]={'value':    8.95156e-01,'fixed':False,'min':0.5,'max':1.5}
#conf['datasets']['sia']['norm'][4011]={'value':    1.00000e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][4012]={'value':    1.00636e+00,'fixed':False,'min':0.5,'max':1.5}
...
conf['params']['ffpion']['g1 N']  ={'value':    1.31509e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['g1 a']  ={'value':    1.47377e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['g1 b']  ={'value':    9.99018e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['g1 c']  ={'value':    3.24388e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['g1 d']  ={'value':    1.11602e+00, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffpion']['u1 N']  ={'value':    6.96516e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['u1 a']  ={'value':   -1.50174e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['u1 b']  ={'value':    9.22811e-01, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['u1 c']  ={'value':    8.01909e-10, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['u1 d']  ={'value':    2.35210e-18, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffpion']['d1 N']  ={'value':    1.27590e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['d1 a']  ={'value':    3.19043e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['d1 b']  ={'value':    7.29361e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['d1 c']  ={'value':    1.46697e-01, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['d1 d']  ={'value':    2.77715e+00, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffpion']['s1 N']  ={'value':    1.27590e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['s1 a']  ={'value':    3.19043e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['s1 b']  ={'value':    7.29361e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffpion']['s1 c']  ={'value':    1.46697e-01, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffpion']['s1 d']  ={'value':    2.77715e+00, 'min':  0   , 'max':    10,'fixed':'d1 d'}

conf['params']['ffpion']['c1 N']  ={'value':    5.43038e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['c1 a']  ={'value':   -1.66992e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['c1 b']  ={'value':    3.47220e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['c1 c']  ={'value':    3.18017e-05, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['c1 d']  ={'value':    2.05282e+00, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffpion']['b1 N']  ={'value':    5.16372e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['b1 a']  ={'value':   -1.73120e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['b1 b']  ={'value':    3.63651e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['b1 c']  ={'value':    1.91078e-26, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['b1 d']  ={'value':    2.42418e-19, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffpion']['ub1 N'] ={'value':    1.27590e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['ub1 a'] ={'value':    3.19043e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['ub1 b'] ={'value':    7.29361e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffpion']['ub1 c']  ={'value':    1.46697e-01, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffpion']['ub1 d']  ={'value':    2.77715e+00, 'min':  0   , 'max':    10,'fixed':'d1 d'}

conf['params']['ffpion']['db1 N'] ={'value':    6.96516e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffpion']['db1 a'] ={'value':   -1.50174e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffpion']['db1 b'] ={'value':    9.22811e-01, 'min':  0   , 'max':    10,'fixed':'u1 b'}
conf['params']['ffpion']['db1 c']  ={'value':    8.01909e-10, 'min':  0   , 'max':    10,'fixed':'u1 c'}
conf['params']['ffpion']['db1 d']  ={'value':    2.35210e-18, 'min':  0   , 'max':    10,'fixed':'u1 d'}

conf['params']['ffpion']['sb1 N'] ={'value':    1.27590e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['sb1 a'] ={'value':    3.19043e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['sb1 b'] ={'value':    7.29361e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffpion']['sb1 c']  ={'value':    1.46697e-01, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffpion']['sb1 d']  ={'value':    2.77715e+00, 'min':  0   , 'max':    10,'fixed':'d1 d'}

conf['params']['ffpion']['cb1 N'] ={'value':    5.43038e-01, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
conf['params']['ffpion']['cb1 a'] ={'value':   -1.66992e+00, 'min': -1.8 , 'max':     2,'fixed':'c1 a'}
conf['params']['ffpion']['cb1 b'] ={'value':    3.47220e+00, 'min':  0   , 'max':    10,'fixed':'c1 b'}
conf['params']['ffpion']['cb1 c']  ={'value':    3.18017e-05, 'min':  0   , 'max':    10,'fixed':'c1 c'}
conf['params']['ffpion']['cb1 d']  ={'value':    2.05282e+00, 'min':  0   , 'max':    10,'fixed':'c1 d'}

conf['params']['ffpion']['bb1 N'] ={'value':    5.16372e-01, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
conf['params']['ffpion']['bb1 a'] ={'value':   -1.73120e+00, 'min': -1.8 , 'max':     2,'fixed':'b1 a'}
conf['params']['ffpion']['bb1 b'] ={'value':    3.63651e+00, 'min':  0   , 'max':    10,'fixed':'b1 b'}
conf['params']['ffpion']['bb1 c']  ={'value':    1.91078e-26, 'min':  0   , 'max':    10,'fixed':'b1 c'}
conf['params']['ffpion']['bb1 d']  ={'value':    2.42418e-19, 'min':  0   , 'max':    10,'fixed':'b1 d'}

conf['params']['ffkaon']={}
conf['ffkaon parametrization']=0

conf['params']['ffkaon']['g1 N']  ={'value':    5.27348e-02, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['g1 a']  ={'value':   -9.73829e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['g1 b']  ={'value':    1.00000e+01, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['g1 c']  ={'value':    2.62432e-30, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['g1 d']  ={'value':    1.74236e-23, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffkaon']['u1 N']  ={'value':    1.04302e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['u1 a']  ={'value':   -8.42360e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['u1 b']  ={'value':    3.78561e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['u1 c']  ={'value':    9.15354e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['u1 d']  ={'value':    4.87428e-02, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffkaon']['d1 N']  ={'value':    9.52988e-02, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['d1 a']  ={'value':   -6.15469e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['d1 b']  ={'value':    1.10746e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['d1 c']  ={'value':    3.50437e-36, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['d1 d']  ={'value':    9.46593e-35, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffkaon']['s1 N']  ={'value':    9.52988e-02, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffkaon']['s1 a']  ={'value':   -6.15469e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffkaon']['s1 b']  ={'value':    1.10746e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffkaon']['s1 c']  ={'value':    3.50437e-36, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffkaon']['s1 d']  ={'value':    9.46593e-35, 'min':  0   , 'max':    10,'fixed':'d1 d'}

conf['params']['ffkaon']['c1 N']  ={'value':    9.77197e-02, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['c1 a']  ={'value':   -3.71356e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['c1 b']  ={'value':    3.47870e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['c1 c']  ={'value':    5.38606e-16, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['c1 d']  ={'value':    1.79674e-20, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffkaon']['b1 N']  ={'value':    3.61786e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['b1 a']  ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['b1 b']  ={'value':    4.41010e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['b1 c']  ={'value':    1.02256e-06, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['b1 d']  ={'value':    1.24128e+00, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffkaon']['ub1 N'] ={'value':    9.52988e-02, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffkaon']['ub1 a'] ={'value':   -6.15469e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffkaon']['ub1 b'] ={'value':    1.10746e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffkaon']['ub1 c']  ={'value':    3.50437e-36, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffkaon']['ub1 d']  ={'value':    9.46593e-35, 'min':  0   , 'max':    10,'fixed':'d1 d'}

conf['params']['ffkaon']['db1 N'] ={'value':    9.52988e-02, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffkaon']['db1 a'] ={'value':   -6.15469e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffkaon']['db1 b'] ={'value':    1.10746e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
conf['params']['ffkaon']['db1 c']  ={'value':    3.50437e-36, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffkaon']['db1 d']  ={'value':    9.46593e-35, 'min':  0   , 'max':    10,'fixed':'d1 d'}

conf['params']['ffkaon']['sb1 N'] ={'value':    7.48681e-02, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['sb1 a'] ={'value':    1.77173e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['sb1 b'] ={'value':    1.00000e+01, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['sb1 c']  ={'value':    5.97291e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffkaon']['sb1 d']  ={'value':    8.34616e-04, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffkaon']['cb1 N'] ={'value':    9.77197e-02, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
conf['params']['ffkaon']['cb1 a'] ={'value':   -3.71356e-01, 'min': -1.8 , 'max':     2,'fixed':'c1 a'}
conf['params']['ffkaon']['cb1 b'] ={'value':    3.47870e+00, 'min':  0   , 'max':    10,'fixed':'c1 b'}
conf['params']['ffkaon']['cb1 c']  ={'value':    5.38606e-16, 'min':  0   , 'max':    10,'fixed':'c1 c'}
conf['params']['ffkaon']['cb1 d']  ={'value':    1.79674e-20, 'min':  0   , 'max':    10,'fixed':'c1 d'}

conf['params']['ffkaon']['bb1 N'] ={'value':    3.61786e-01, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
conf['params']['ffkaon']['bb1 a'] ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'b1 a'}
conf['params']['ffkaon']['bb1 b'] ={'value':    4.41010e+00, 'min':  0   , 'max':    10,'fixed':'b1 b'}
conf['params']['ffkaon']['bb1 c']  ={'value':    1.02256e-06, 'min':  0   , 'max':    10,'fixed':'b1 c'}
conf['params']['ffkaon']['bb1 d']  ={'value':    1.24128e+00, 'min':  0   , 'max':    10,'fixed':'b1 d'}

conf['params']['ffhadron']={}
conf['ffhadron parametrization']='sum2'

conf['params']['ffhadron']['g1 N']  ={'value':    8.15757e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['g1 c']  ={'value':    6.93599e-15, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffhadron']['g1 d']  ={'value':    6.50328e-25, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffhadron']['u1 N']  ={'value':    1.99182e-01, 'min':  0.0 , 'max':     1,'fixed':True}
conf['params']['ffhadron']['u1 a']  ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffhadron']['u1 b']  ={'value':    2.27734e+00, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffhadron']['u1 c']  ={'value':    2.78502e-24, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffhadron']['u1 d']  ={'value':    2.21472e-22, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffhadron']['d1 N']  ={'value':    1.99182e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['d1 a']  ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['d1 b']  ={'value':    2.27734e+00, 'min':  0   , 'max':    10,'fixed':'u1 b'}
conf['params']['ffhadron']['d1 c']  ={'value':    2.78502e-24, 'min':  0   , 'max':    10,'fixed':'u1 c'}
conf['params']['ffhadron']['d1 d']  ={'value':    2.21472e-22, 'min':  0   , 'max':    10,'fixed':'u1 d'}

conf['params']['ffhadron']['s1 N']  ={'value':    7.77112e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['s1 a']  ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['s1 b']  ={'value':    2.27734e+00, 'min':  0   , 'max':    10,'fixed':'u1 b'}
conf['params']['ffhadron']['s1 c']  ={'value':    2.78502e-24, 'min':  0   , 'max':    10,'fixed':'u1 c'}
conf['params']['ffhadron']['s1 d']  ={'value':    2.21472e-22, 'min':  0   , 'max':    10,'fixed':'u1 d'}

conf['params']['ffhadron']['c1 N']  ={'value':    3.59243e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['c1 c']  ={'value':    9.68969e-25, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffhadron']['c1 d']  ={'value':    1.11887e-24, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffhadron']['b1 N']  ={'value':    1.21843e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['b1 c']  ={'value':    1.00908e-24, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffhadron']['b1 d']  ={'value':    1.68417e-24, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffhadron']['ub1 N'] ={'value':    7.77112e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['ub1 a'] ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['ub1 b'] ={'value':    2.27734e+00, 'min':  0   , 'max':    10,'fixed':'u1 b'}
conf['params']['ffhadron']['ub1 c']  ={'value':    2.78502e-24, 'min':  0   , 'max':    10,'fixed':'u1 c'}
conf['params']['ffhadron']['ub1 d']  ={'value':    2.21472e-22, 'min':  0   , 'max':    10,'fixed':'u1 d'}

conf['params']['ffhadron']['db1 N'] ={'value':    2.08185e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['db1 a'] ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['db1 b'] ={'value':    2.27734e+00, 'min':  0   , 'max':    10,'fixed':'u1 b'}
conf['params']['ffhadron']['db1 c']  ={'value':    2.78502e-24, 'min':  0   , 'max':    10,'fixed':'u1 c'}
conf['params']['ffhadron']['db1 d']  ={'value':    2.21472e-22, 'min':  0   , 'max':    10,'fixed':'u1 d'}

conf['params']['ffhadron']['sb1 N'] ={'value':    1.99182e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['sb1 a'] ={'value':   -1.80000e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['sb1 b'] ={'value':    2.27734e+00, 'min':  0   , 'max':    10,'fixed':'u1 b'}
conf['params']['ffhadron']['sb1 c']  ={'value':    2.78502e-24, 'min':  0   , 'max':    10,'fixed':'u1 c'}
conf['params']['ffhadron']['sb1 d']  ={'value':    2.21472e-22, 'min':  0   , 'max':    10,'fixed':'u1 d'}

conf['params']['ffhadron']['cb1 N'] ={'value':    3.59243e-01, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
...
conf['params']['ffhadron']['cb1 c']  ={'value':    9.68969e-25, 'min':  0   , 'max':    10,'fixed':'c1 c'}
conf['params']['ffhadron']['cb1 d']  ={'value':    1.11887e-24, 'min':  0   , 'max':    10,'fixed':'c1 d'}

conf['params']['ffhadron']['bb1 N'] ={'value':    1.21843e-01, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
...
conf['params']['ffhadron']['bb1 c']  ={'value':    1.00908e-24, 'min':  0   , 'max':    10,'fixed':'b1 c'}
conf['params']['ffhadron']['bb1 d']  ={'value':    1.68417e-24, 'min':  0   , 'max':    10,'fixed':'b1 d'}
...
conf['steps'][3]['datasets']['sia'].append(4003)
...
conf['steps'][3]['datasets']['sia'].append(4008)
conf['steps'][3]['datasets']['sia'].append(4009)
conf['steps'][3]['datasets']['sia'].append(4010)
conf['steps'][3]['datasets']['sia'].append(4011)
