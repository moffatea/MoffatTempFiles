...
conf['datasets']['sia']['norm'][4000]={'value':    1.00000e+00,'fixed':False,'min':0.97,'max':1.03}
conf['datasets']['sia']['norm'][4002]={'value':    1.00000e+00,'fixed':False,'min':0.99,'max':1.01}
conf['datasets']['sia']['norm'][4003]={'value':    1.00000e+00,'fixed':False,'min':0.955,'max':1.045}
conf['datasets']['sia']['norm'][4008]={'value':    1.00000e+00,'fixed':False,'min':0.955,'max':1.045}
conf['datasets']['sia']['norm'][4009]={'value':    1.00000e+00,'fixed':False,'min':0.955,'max':1.045}
conf['datasets']['sia']['norm'][4010]={'value':    1.00000e+00,'fixed':False,'min':0.955,'max':1.045}
conf['datasets']['sia']['norm'][4011]={'value':    1.00000e+00,'fixed':False,'min':0.955,'max':1.045}
conf['datasets']['sia']['norm'][4012]={'value':    1.00000e+00,'fixed':False,'min':0.955,'max':1.045}
