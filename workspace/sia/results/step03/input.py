...
conf['params']['ffpion']['g1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['g1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
...
conf['params']['ffpion']['u1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['u1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
...
conf['params']['ffpion']['d1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['d1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
...
conf['params']['ffpion']['s1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffpion']['s1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'d1 d'}
...
conf['params']['ffpion']['c1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['c1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
...
conf['params']['ffpion']['b1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
conf['params']['ffpion']['b1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':False}
...
conf['params']['ffpion']['ub1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffpion']['ub1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'d1 d'}
...
conf['params']['ffpion']['db1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'u1 c'}
conf['params']['ffpion']['db1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'u1 d'}
...
conf['params']['ffpion']['sb1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'d1 c'}
conf['params']['ffpion']['sb1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'d1 d'}
...
conf['params']['ffpion']['cb1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'c1 c'}
conf['params']['ffpion']['cb1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'c1 d'}
...
conf['params']['ffpion']['bb1 c']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'b1 c'}
conf['params']['ffpion']['bb1 d']  ={'value':    0.0, 'min':  0   , 'max':    10,'fixed':'b1 d'}
