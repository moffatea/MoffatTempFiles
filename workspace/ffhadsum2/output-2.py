...
conf['datasets']['sia']['filters'].append('(hadron=="pion" and ((RS<91.2 and z>0.1) or (RS>=91.2 and z>0.05))) or (hadron!="pion" and (((col=="ARGUS" or col=="BABAR") and z>0.2) or ((col!="ARGUS" and col!="BABAR") and RS<91.2 and z>0.1) or (col!="ARGUS" and col!="BABAR") and RS>=91.2 and z>0.05))')
...
conf['datasets']['sia']['xlsx'][1009]='sia/expdata/1009.xlsx'  # hadron: pion exp: TPC(uds)
...
conf['datasets']['sia']['xlsx'][1015]='sia/expdata/1015.xlsx'  # hadron: pion exp: SLD(uds)
...
conf['datasets']['sia']['xlsx'][1020]='sia/expdata/1020.xlsx'  # hadron: pion exp: OPAL(u)
conf['datasets']['sia']['xlsx'][1021]='sia/expdata/1021.xlsx'  # hadron: pion exp: OPAL(d)
conf['datasets']['sia']['xlsx'][1022]='sia/expdata/1022.xlsx'  # hadron: pion exp: OPAL(s)
conf['datasets']['sia']['xlsx'][1025]='sia/expdata/1025.xlsx'  # hadron: pion exp: DELPHI
conf['datasets']['sia']['xlsx'][1026]='sia/expdata/1026.xlsx'  # hadron: pion exp: DELPHI(uds)
...
conf['datasets']['sia']['norm'][1015]={'value':    9.97770e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][1018]={'value':    1.02378e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][1020]={'value':    1.02378e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][1021]={'value':    1.02378e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][1022]={'value':    1.02378e+00,'fixed':False,'min':0.5,'max':1.5}
...
conf['datasets']['sia']['xlsx'][2015]='sia/expdata/2015.xlsx'  # hadron: kaon exp: SLD(uds)
...
conf['datasets']['sia']['xlsx'][2020]='sia/expdata/2020.xlsx'  # hadron: kaon exp: OPAL(u)
conf['datasets']['sia']['xlsx'][2021]='sia/expdata/2021.xlsx'  # hadron: kaon exp: OPAL(d)
conf['datasets']['sia']['xlsx'][2022]='sia/expdata/2022.xlsx'  # hadron: kaon exp: OPAL(s)
conf['datasets']['sia']['xlsx'][2025]='sia/expdata/2025.xlsx'  # hadron: kaon exp: DELPHI
conf['datasets']['sia']['xlsx'][2026]='sia/expdata/2026.xlsx'  # hadron: kaon exp: DELPHI(uds)
conf['datasets']['sia']['xlsx'][2031]='sia/expdata/2031.xlsx'  # hadron: kaon exp: DELPHI
conf['datasets']['sia']['norm'][2030]={'value':    1.00889e+00,'fixed':False,'min':0.5,'max':1.5,'dN':0.1}
conf['datasets']['sia']['norm'][2028]={'value':    9.98907e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2029]={'value':    1.00000e+00,'fixed':True,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2002]={'value':    9.26542e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2003]={'value':    1.00833e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2005]={'value':    1.00255e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2014]={'value':    9.89523e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2015]={'value':    9.85733e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2018]={'value':    1.00244e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2020]={'value':    1.17463e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2021]={'value':    9.86580e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2022]={'value':    1.06426e+00,'fixed':False,'min':0.5,'max':1.5}
...
conf['datasets']['sia']['norm'][2016]={'value':    9.99135e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2017]={'value':    9.86522e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2023]={'value':    1.22875e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2024]={'value':    1.27194e+00,'fixed':False,'min':0.5,'max':1.5}
...
conf['params']['ffpion']['g1 N']  ={'value':    1.80352e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['g1 a']  ={'value':    2.00000e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['g1 b']  ={'value':    1.00000e+01, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffpion']['g1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffpion']['g1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['u1 N']  ={'value':    4.80729e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['u1 a']  ={'value':   -1.33808e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['u1 b']  ={'value':    9.04998e-01, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffpion']['u1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffpion']['u1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['d1 N']  ={'value':    1.38420e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['d1 a']  ={'value':    3.76683e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['d1 b']  ={'value':    6.15614e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffpion']['d1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffpion']['d1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['s1 N']  ={'value':    1.38420e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['s1 a']  ={'value':    3.76683e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['s1 b']  ={'value':    6.15614e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
#conf['params']['ffpion']['s1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 c'}
#conf['params']['ffpion']['s1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffpion']['c1 N']  ={'value':    2.03477e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['c1 a']  ={'value':   -7.94289e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['c1 b']  ={'value':    4.07025e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffpion']['c1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffpion']['c1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['b1 N']  ={'value':    2.67056e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['b1 a']  ={'value':   -1.29500e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['b1 b']  ={'value':    5.29754e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffpion']['b1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffpion']['b1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffpion']['ub1 N'] ={'value':    1.38420e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['ub1 a'] ={'value':    3.76683e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['ub1 b'] ={'value':    6.15614e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
#conf['params']['ffpion']['ub1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 c'}
#conf['params']['ffpion']['ub1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffpion']['db1 N'] ={'value':    4.80729e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffpion']['db1 a'] ={'value':   -1.33808e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffpion']['db1 b'] ={'value':    9.04998e-01, 'min':  0   , 'max':    10,'fixed':'u1 b'}
#conf['params']['ffpion']['db1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffpion']['db1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffpion']['sb1 N'] ={'value':    1.38420e-01, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffpion']['sb1 a'] ={'value':    3.76683e-01, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffpion']['sb1 b'] ={'value':    6.15614e+00, 'min':  0   , 'max':    10,'fixed':'d1 b'}
#conf['params']['ffpion']['sb1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 c'}
#conf['params']['ffpion']['sb1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffpion']['cb1 N'] ={'value':    2.03477e-01, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
conf['params']['ffpion']['cb1 a'] ={'value':   -7.94289e-01, 'min': -1.8 , 'max':     2,'fixed':'c1 a'}
conf['params']['ffpion']['cb1 b'] ={'value':    4.07025e+00, 'min':  0   , 'max':    10,'fixed':'c1 b'}
#conf['params']['ffpion']['cb1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'c1 c'}
#conf['params']['ffpion']['cb1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'c1 d'}

conf['params']['ffpion']['bb1 N'] ={'value':    2.67056e-01, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
conf['params']['ffpion']['bb1 a'] ={'value':   -1.29500e+00, 'min': -1.8 , 'max':     2,'fixed':'b1 a'}
conf['params']['ffpion']['bb1 b'] ={'value':    5.29754e+00, 'min':  0   , 'max':    10,'fixed':'b1 b'}
...
conf['params']['ffkaon']['g1 N']  ={'value':    3.26185e-02, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['g1 a']  ={'value':    2.00000e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['g1 b']  ={'value':    1.60314e-12, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffkaon']['g1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffkaon']['g1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffkaon']['u1 N']  ={'value':    1.91037e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['u1 a']  ={'value':   -8.01137e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['u1 b']  ={'value':    1.62718e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffkaon']['u1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffkaon']['u1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffkaon']['d1 N']  ={'value':    1.74719e-03, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['d1 a']  ={'value':    1.99976e+00, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['d1 b']  ={'value':    3.62821e-02, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffkaon']['d1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffkaon']['d1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffkaon']['s1 N']  ={'value':    1.74719e-03, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffkaon']['s1 a']  ={'value':    1.99976e+00, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffkaon']['s1 b']  ={'value':    3.62821e-02, 'min':  0   , 'max':    10,'fixed':'d1 b'}
#conf['params']['ffkaon']['s1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 c'}
#conf['params']['ffkaon']['s1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffkaon']['c1 N']  ={'value':    7.81439e-02, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['c1 a']  ={'value':    2.98190e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['c1 b']  ={'value':    5.50608e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffkaon']['c1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffkaon']['c1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffkaon']['b1 N']  ={'value':    5.97659e-02, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['b1 a']  ={'value':    2.28439e-02, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['b1 b']  ={'value':    9.85150e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffkaon']['b1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffkaon']['b1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffkaon']['ub1 N'] ={'value':    1.74719e-03, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffkaon']['ub1 a'] ={'value':    1.99976e+00, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffkaon']['ub1 b'] ={'value':    3.62821e-02, 'min':  0   , 'max':    10,'fixed':'d1 b'}
#conf['params']['ffkaon']['ub1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 c'}
#conf['params']['ffkaon']['ub1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffkaon']['db1 N'] ={'value':    1.74719e-03, 'min':  0.0 , 'max':     1,'fixed':'d1 N'}
conf['params']['ffkaon']['db1 a'] ={'value':    1.99976e+00, 'min': -1.8 , 'max':     2,'fixed':'d1 a'}
conf['params']['ffkaon']['db1 b'] ={'value':    3.62821e-02, 'min':  0   , 'max':    10,'fixed':'d1 b'}
#conf['params']['ffkaon']['db1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 c'}
#conf['params']['ffkaon']['db1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'d1 d'}

conf['params']['ffkaon']['sb1 N'] ={'value':    2.46951e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffkaon']['sb1 a'] ={'value':   -5.30979e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffkaon']['sb1 b'] ={'value':    1.69338e+00, 'min':  0   , 'max':    10,'fixed':False}
#conf['params']['ffkaon']['sb1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffkaon']['sb1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffkaon']['cb1 N'] ={'value':    7.81439e-02, 'min':  0.0 , 'max':     1,'fixed':'c1 N'}
conf['params']['ffkaon']['cb1 a'] ={'value':    2.98190e-01, 'min': -1.8 , 'max':     2,'fixed':'c1 a'}
conf['params']['ffkaon']['cb1 b'] ={'value':    5.50608e+00, 'min':  0   , 'max':    10,'fixed':'c1 b'}
#conf['params']['ffkaon']['cb1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'c1 c'}
#conf['params']['ffkaon']['cb1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'c1 d'}

conf['params']['ffkaon']['bb1 N'] ={'value':    5.97659e-02, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
conf['params']['ffkaon']['bb1 a'] ={'value':    2.28439e-02, 'min': -1.8 , 'max':     2,'fixed':'b1 a'}
conf['params']['ffkaon']['bb1 b'] ={'value':    9.85150e+00, 'min':  0   , 'max':    10,'fixed':'b1 b'}
...
conf['params']['ffhadron']['g1 N']  ={'value':   2.33320e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
#conf['params']['ffhadron']['g1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffhadron']['g1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}

conf['params']['ffhadron']['u1 N']  ={'value':   4.03672e-02, 'min':  0.0 , 'max':     1,'fixed':True}
...
#conf['params']['ffhadron']['u1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
#conf['params']['ffhadron']['u1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':False}
...
#conf['params']['ffhadron']['d1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['d1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}
...
#conf['params']['ffhadron']['s1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['s1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffhadron']['c1 N']  ={'value':   7.76923e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['b1 N']  ={'value':   5.66971e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['ub1 N'] ={'value':   4.03672e-02, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['ub1 a'] ={'value':   2.26356e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['ub1 b'] ={'value':   1.62596e+00, 'min':  0   , 'max':    10,'fixed':'u1 b'}
#conf['params']['ffhadron']['ub1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['ub1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffhadron']['db1 N'] ={'value':   2.51671e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['db1 a'] ={'value':  -1.43444e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['db1 b'] ={'value':   1.65143e+00, 'min':  0   , 'max':    20,'fixed':'u1 b'}
#conf['params']['ffhadron']['db1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['db1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}

conf['params']['ffhadron']['sb1 N'] ={'value':   2.51671e-01, 'min':  0.0 , 'max':     1,'fixed':'u1 N'}
conf['params']['ffhadron']['sb1 a'] ={'value':  -1.43444e+00, 'min': -1.8 , 'max':     2,'fixed':'u1 a'}
conf['params']['ffhadron']['sb1 b'] ={'value':   1.65143e+00, 'min':  0   , 'max':    10,'fixed':'u1 b'}
#conf['params']['ffhadron']['sb1 c']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 c'}
#conf['params']['ffhadron']['sb1 d']  ={'value':    0.0, 'min':  0   , 'max':    20,'fixed':'u1 d'}
...
conf['params']['ffhadron']['cb1 b'] ={'value':   2.50452e+00, 'min':  0   , 'max':    10,'fixed':'c1 b'}
...
conf['params']['ffhadron']['bb1 b'] ={'value':   3.41727e+00, 'min':  0   , 'max':    10,'fixed':'b1 b'}
...
#conf['steps'][1]['datasets']['sia'].append(1009)
...
#conf['steps'][1]['datasets']['sia'].append(1015)
...
#conf['steps'][1]['datasets']['sia'].append(1020)
#conf['steps'][1]['datasets']['sia'].append(1021)
#conf['steps'][1]['datasets']['sia'].append(1022)
#conf['steps'][1]['datasets']['sia'].append(1023)
#conf['steps'][1]['datasets']['sia'].append(1024)
#conf['steps'][1]['datasets']['sia'].append(1025)
#conf['steps'][1]['datasets']['sia'].append(1026)
...
conf['steps'][2]['datasets']['sia'].append(2015)
conf['steps'][2]['datasets']['sia'].append(2018)
conf['steps'][2]['datasets']['sia'].append(2019)
conf['steps'][2]['datasets']['sia'].append(2020)
conf['steps'][2]['datasets']['sia'].append(2021)
conf['steps'][2]['datasets']['sia'].append(2022)
conf['steps'][2]['datasets']['sia'].append(2025)
conf['steps'][2]['datasets']['sia'].append(2026)
...
#conf['steps'][6]['passive distributions']=['pdf']
