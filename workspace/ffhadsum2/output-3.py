...
conf['datasets']['sia']['filters'].append('(hadron=="pion" and ((RS<91.2 and z>0.1) or (RS>=91.2 and z>0.05))) or (hadron=="kaon" and (((col=="ARGUS" or col=="BABAR") and z>0.2) or ((col!="ARGUS" and col!="BABAR") and RS<91.2 and z>0.1) or (col!="ARGUS" and col!="BABAR") and RS>=91.2 and z>0.05)) or (hadron=="hadron" and z>0.2 and z<0.9)')
...
conf['datasets']['sia']['norm'][2015]={'value':    9.12186e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2018]={'value':    8.88453e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2020]={'value':    9.12186e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2021]={'value':    9.12186e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][2022]={'value':    9.12186e-01,'fixed':False,'min':0.5,'max':1.5}
...
conf['datasets']['sia']['norm'][4000]={'value':    1.03433e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][4002]={'value':    1.02377e+00,'fixed':False,'min':0.5,'max':1.5}
...
conf['datasets']['sia']['norm'][4009]={'value':    8.68318e-01,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][4010]={'value':    1.03743e+00,'fixed':False,'min':0.5,'max':1.5}
#conf['datasets']['sia']['norm'][4011]={'value':    1.00000e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['sia']['norm'][4012]={'value':    9.83353e-01,'fixed':False,'min':0.5,'max':1.5}
...
conf['params']['ffhadron']['b1 N']  ={'value':    6.73178e-01, 'min':  0.0 , 'max':     1,'fixed':True}
...
conf['params']['ffhadron']['bb1 N'] ={'value':    6.73178e-01, 'min':  0.0 , 'max':     1,'fixed':'b1 N'}
