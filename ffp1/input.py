...
conf['params']['ffpion']['u2 N']  ={'value':    0.0          , 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['u2 a']  ={'value':    1.76877e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['u2 b']  ={'value':    4.81521e+00, 'min':  0   , 'max':    10,'fixed':False}
...
conf['params']['ffpion']['d2 N']  ={'value':    0.0          , 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['d2 a']  ={'value':   -6.89477e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['d2 b']  ={'value':    4.79992e+00, 'min':  0   , 'max':    10,'fixed':False}

conf['params']['ffpion']['s1 N']  ={'value':    1.54863e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['ffpion']['s1 a']  ={'value':    3.00305e-01, 'min': -1.8 , 'max':     2,'fixed':False}
conf['params']['ffpion']['s1 b']  ={'value':    1.83178e+00, 'min':  0   , 'max':    10,'fixed':False}
...
conf['params']['ffpion']['ub2 N'] ={'value':    2.99974e-01, 'min':  0.0 , 'max':     1,'fixed':'d2 N'}
conf['params']['ffpion']['ub2 a'] ={'value':   -6.89477e-01, 'min': -1.8 , 'max':     2,'fixed':'d2 a'}
conf['params']['ffpion']['ub2 b'] ={'value':    4.79992e+00, 'min':  0   , 'max':    10,'fixed':'d2 b'}
...
conf['params']['ffpion']['db2 N'] ={'value':    2.67821e-02, 'min':  0.0 , 'max':     1,'fixed':'u2 N'}
conf['params']['ffpion']['db2 a'] ={'value':    1.76877e-01, 'min': -1.8 , 'max':     2,'fixed':'u2 a'}
conf['params']['ffpion']['db2 b'] ={'value':    4.81521e+00, 'min':  0   , 'max':    10,'fixed':'u2 b'}

conf['params']['ffpion']['sb1 N'] ={'value':    1.54863e-01, 'min':  0.0 , 'max':     1,'fixed':'s1 N'}
conf['params']['ffpion']['sb1 a'] ={'value':    3.00305e-01, 'min': -1.8 , 'max':     2,'fixed':'s1 a'}
conf['params']['ffpion']['sb1 b'] ={'value':    1.83178e+00, 'min':  0   , 'max':    10,'fixed':'s1 b'}
