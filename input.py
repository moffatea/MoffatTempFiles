...
conf['idis grid']=[]
conf['idis grid'].append('%s/database/sidis/expdata/1005.xlsx'%os.environ['FITPACK'])
conf['idis grid'].append('%s/database/sidis/expdata/1006.xlsx'%os.environ['FITPACK'])
conf['idis grid'].append('%s/database/sidis/expdata/2005.xlsx'%os.environ['FITPACK'])
conf['idis grid'].append('%s/database/sidis/expdata/2006.xlsx'%os.environ['FITPACK'])
conf['idis grid'].append('%s/database/sidis/expdata/3000.xlsx'%os.environ['FITPACK'])
conf['idis grid'].append('%s/database/sidis/expdata/3001.xlsx'%os.environ['FITPACK'])
...
#--all ffs and pdf sia, sidis,  dis, and dy with optimal priors from step10 
conf['steps'][11]={} 
conf['steps'][11]['dep']=[10] 
conf['steps'][11]['active distributions']=['pdf','ffpion','ffkaon','ffhadron'] 
conf['steps'][11]['datasets']={} 
conf['steps'][11]['datasets']['sidis']=[] 
conf['steps'][11]['datasets']['sidis'].append(1005) # deuteron , mult , pi+ , COMPASS
conf['steps'][11]['datasets']['sidis'].append(1006) # deuteron , mult , pi- , COMPASS
conf['steps'][11]['datasets']['sidis'].append(2005) # deuteron , mult , K+  , COMPASS
conf['steps'][11]['datasets']['sidis'].append(2006) # deuteron , mult , K-  , COMPASS
conf['steps'][11]['datasets']['sidis'].append(3000) # deuteron , mult , h+  , COMPASS 
conf['steps'][11]['datasets']['sidis'].append(3001) # deuteron , mult , h-  , COMPASS 
conf['steps'][11]['datasets']['sia']=[] 
conf['steps'][11]['datasets']['sia'].append(1001)  # hadron: pion exp: TASSO
conf['steps'][11]['datasets']['sia'].append(1002)  # hadron: pion exp: TASSO
conf['steps'][11]['datasets']['sia'].append(1003)  # hadron: pion exp: TASSO
conf['steps'][11]['datasets']['sia'].append(1004)  # hadron: pion exp: TASSO
conf['steps'][11]['datasets']['sia'].append(1005)  # hadron: pion exp: TASSO
conf['steps'][11]['datasets']['sia'].append(1006)  # hadron: pion exp: TASSO
conf['steps'][11]['datasets']['sia'].append(1007)  # hadron: pion exp: TPC
conf['steps'][11]['datasets']['sia'].append(1008)  # hadron: pion exp: TPC
conf['steps'][11]['datasets']['sia'].append(1012)  # hadron: pion exp: HRS
conf['steps'][11]['datasets']['sia'].append(1013)  # hadron: pion exp: TOPAZ
conf['steps'][11]['datasets']['sia'].append(1014)  # hadron: pion exp: SLD
conf['steps'][11]['datasets']['sia'].append(1018)  # hadron: pion exp: ALEPH
conf['steps'][11]['datasets']['sia'].append(1019)  # hadron: pion exp: OPAL
conf['steps'][11]['datasets']['sia'].append(1025)  # hadron: pion exp: DELPHI
conf['steps'][11]['datasets']['sia'].append(1028)  # hadron: pion exp: BABAR
conf['steps'][11]['datasets']['sia'].append(1029)  # hadron: pion exp: BELL
conf['steps'][11]['datasets']['sia'].append(1030)  # hadron: pion exp: ARGUS
conf['steps'][11]['datasets']['sia'].append(1010)  # hadron: pion exp: TPC(c)
conf['steps'][11]['datasets']['sia'].append(1011)  # hadron: pion exp: TPC(b)
conf['steps'][11]['datasets']['sia'].append(1016)  # hadron: pion exp: SLD(c)
conf['steps'][11]['datasets']['sia'].append(1017)  # hadron: pion exp: SLD(b)
conf['steps'][11]['datasets']['sia'].append(1023)  # hadron: pion exp: OPAL(c)
conf['steps'][11]['datasets']['sia'].append(1024)  # hadron: pion exp: OPAL(b)
conf['steps'][11]['datasets']['sia'].append(1027)  # hadron: pion exp: DELPHI(b)
conf['steps'][11]['datasets']['sia'].append(2030)  # hadron: kaon exp: ARGUS
conf['steps'][11]['datasets']['sia'].append(2028)  # hadron: kaon exp: BABAR
conf['steps'][11]['datasets']['sia'].append(2029)  # hadron: kaon exp: BELL
conf['steps'][11]['datasets']['sia'].append(2001)  # hadron: kaon exp: TASSO
conf['steps'][11]['datasets']['sia'].append(2002)  # hadron: kaon exp: TASSO
conf['steps'][11]['datasets']['sia'].append(2003)  # hadron: kaon exp: TASSO
conf['steps'][11]['datasets']['sia'].append(2004)  # hadron: kaon exp: TASSO
conf['steps'][11]['datasets']['sia'].append(2005)  # hadron: kaon exp: TASSO
conf['steps'][11]['datasets']['sia'].append(2006)  # hadron: kaon exp: TASSO
conf['steps'][11]['datasets']['sia'].append(2007)  # hadron: kaon exp: TPC
conf['steps'][11]['datasets']['sia'].append(2008)  # hadron: kaon exp: TPC
conf['steps'][11]['datasets']['sia'].append(2012)  # hadron: kaon exp: HRS
conf['steps'][11]['datasets']['sia'].append(2013)  # hadron: kaon exp: TOPAZ
conf['steps'][11]['datasets']['sia'].append(2014)  # hadron: kaon exp: SLD
conf['steps'][11]['datasets']['sia'].append(2018)  # hadron: kaon exp: ALEPH
conf['steps'][11]['datasets']['sia'].append(2019)  # hadron: kaon exp: OPAL
conf['steps'][11]['datasets']['sia'].append(2025)  # hadron: kaon exp: DELPHI
conf['steps'][11]['datasets']['sia'].append(2031)  # hadron: kaon exp: DELPHI
conf['steps'][11]['datasets']['sia'].append(2016)  # hadron: kaon exp: SLD(c)
conf['steps'][11]['datasets']['sia'].append(2017)  # hadron: kaon exp: SLD(b)
conf['steps'][11]['datasets']['sia'].append(2023)  # hadron: kaon exp: OPAL(c)
conf['steps'][11]['datasets']['sia'].append(2024)  # hadron: kaon exp: OPAL(b)
conf['steps'][11]['datasets']['sia'].append(2027)  # hadron: kaon exp: DELPHI(b)
conf['steps'][11]['datasets']['sia'].append(4000) 
conf['steps'][11]['datasets']['sia'].append(4001) 
conf['steps'][11]['datasets']['sia'].append(4002) 
conf['steps'][11]['datasets']['sia'].append(4004) 
conf['steps'][11]['datasets']['sia'].append(4005) 
conf['steps'][11]['datasets']['sia'].append(4006) 
conf['steps'][11]['datasets']['sia'].append(4007) 
conf['steps'][11]['datasets']['sia'].append(4011) 
conf['steps'][11]['datasets']['sia'].append(4012) 
conf['steps'][11]['datasets']['sia'].append(4013) 
conf['steps'][11]['datasets']['sia'].append(4014) 
conf['steps'][11]['datasets']['sia'].append(4015) 
...
conf['steps'][11]['datasets']['idis'].append(10032) # proton   | sigma red     | HERA II NC e-
